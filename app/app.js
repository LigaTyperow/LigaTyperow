...
app.use(helmet({
    //ustawiamy jaki linki chcemy akceptować (dyrektywy)
    //dopóki nie skończymy aplikacji nie chce komplikować dodawania zewnętrznych linków, można to włączyć na koniec
